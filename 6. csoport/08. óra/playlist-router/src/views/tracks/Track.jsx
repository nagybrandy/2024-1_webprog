...
export function Track({ track, handleDelete, setEdit, handleEdit }) {
  ...
  return (
    ...
    <div className="flex p-3 w-[100%] hover:bg-base-100 rounded-lg items-center">
      ...
      <button className="btn bg-neutral px-1 rounded-lg mr-2 w-12 h-12 hover:bg-base-100" onClick={() => handleEdit(track)}>
          <EditIcon />
        </button>
        <button 
          className="btn bg-red-400 px-1 rounded-lg mr-2 w-12 h-12  hover:bg-red-600"
